...
if ( ! $hide_pdfbutton ) { ?>
	...
	<div class="dkpdf-button-container" style="<?php echo apply_filters( 'dkpdf_button_container_css', '' );?> text-align:<?php echo $pdfbutton_align;?> ">
		...
		<a class="dkpdf-button" href="<?php echo esc_url( add_query_arg( 'pdf', $post->ID ) );?>" target="_blank"><span class="dkpdf-button-icon"><i class="fa-brands fa-readme"></i></span>&nbsp;&nbsp;&nbsp; <?php echo $pdfbutton_text;?></a>
