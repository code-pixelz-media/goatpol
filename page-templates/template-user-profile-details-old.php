...
/**
 * Template Name: Publishing User Information Old
 *
        ...
        <div id="post-content" class="section-inner">
            <div class="section-inner">
                <div class="entry-content edit-user-innfo">
                    ...
                    if (isset($_POST['cpm_update_user_info'])) {
                        ...
                        if($_FILES)
                        {
                            foreach ($_FILES as $file => $array)
                            {
                                ...
                                $profile_picture = wp_get_attachment_url($attach_id);//upload file URL
                            }
                        }
                        ...
                        if (!is_wp_error($user_data)) {
                            ...
                            update_user_meta($user_id, 'cpm_payment_method', $cpm_payment_method);
                            update_user_meta($user_id, 'cpm_payment_details', $cpm_payment_details);
                            ...
                            <script>window.location.href = "<?php echo home_url('/registration'); ?>"</script>
                            <?php
                        } else {
                            ?>
                    ...
                    <div id="form-err"></div>
                    <form action="" method="POST" enctype="multipart/form-data" id="cpm-update-user-information"
                        class="cpm-user-informations">
                        <?php
                        $current_user = get_user_by('id', $current_user_id);
                        $user_id = $current_user->ID;
                        ...
                        $cpm_payment_method = get_user_meta($user_id, 'cpm_payment_method', true);
                        $cpm_payment_details = get_user_meta($user_id, 'cpm_payment_details', true);
                        ?>
                        ...
                        <div class=" form-group update_profile_picture">
                            ...
                            <img src="<?php echo $avatar_img_url; ?>" alt="profile picture" width="80"
                        ...
                        <div class='form-infos'>
                                ...
                                <div class="user-full-location">
                                    ...
                                    <div class="user-full-location-fields">
                                        <div>
                                            ...
                                            <!-- <input type="text" class="current_location fill-city-grewup"
                                                name="grew_up_location_city" placeholder="City" value="<?php
                            ...
                            <div class="form-group ">
                                ...
                                <div class="user-full-location">
                                    <!-- <input type="text" class="current_location" name="current_location"
                                        placeholder="Location" value="<?php
                                    ...
                                    <div class="user-full-location-fields">
                                        <div>
                                            ...
                                            <!-- <input type="text" class="current_location fill-city-now" name="current_location_city"
                            ...
                            <div class="form-group">
                                ...
                                <select name="write_for[]" class="write_for" multiple="multiple">
                                    ...
                                    <!-- <option value="other" <?php //echo (in_array('other', $write_for)) ? 'selected' : ''; ?>>
                                        Other
                                    </option> -->
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" class="reason_for_writing" name="reason_for_writing" 
                                value="<?php
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="user_address" name="user_address" ><?php
                        ...
                        <div class="wp-block-buttons"  style="<?php if(!$has_updated_contributors_page){ echo 'display:none'; }?>" >
                            <button type="submit" class="wp-block-button wp-block-button__link cpm_update_user_info" name="cpm_update_user_info">Save</button>
                        </div>
                    </form>
                    <?php if(!$has_updated_contributors_page){ ?>
                        <div class="wp-block-buttons">
                            <button class="wp-block-button wp-block-button__link cpm_update_user_open_ground_rules">Save</button>
                        </div>
                    <?php } ?>
                    ...
                    <!-- <div class="contributors-payment-details">
                    ...
                    <p class="profile-paragraph">
                        ...
                        <strong>
                            NOTE: we do NOT pay for pieces that you upload on your Contributor’s Page (see “Upload Your Work,” below). </strong>
                            But, <strong>when a RAE commissions you to work with us and publish on The GOAT PoL, we will pay you $70 CAD. 
                            The “payment details” you provide below show us how to pay you. Be sure to fill them in if you want to be paid for your work.
                        </strong>
                    </p>
                    <?php
                        if (isset($_POST['cpm_update_user_payment_info'])) {
                            $cpm_payment_method = $_POST['cpm_payment_method'];
                            $cpm_payment_details = $_POST['cpm_payment_details'];
                            update_user_meta($current_user->ID, 'cpm_payment_method', $cpm_payment_method);
                            update_user_meta($current_user->ID, 'cpm_payment_details', $cpm_payment_details);
                    ...
                    ?>
                    <form action="" method="POST" enctype="multipart/form-data" id="cpm-update-user-payment-information"
                        class="cpm-user-informations">
                        <div class="form-group">
                            <label for="cpm_payment_method">Payment Method<span class="required-field">*</span></label>
                            <select name="cpm_payment_method" id="" class="cpm_payment_method" selected="
                                <?php
                                if (!empty($cpm_payment_method)) {
                                    echo $cpm_payment_method;
                                }
                                ?>
                            " required>
                                <option value="">Choose Payment Method</option>
                                <option value="PayPal" <?php if ($cpm_payment_method == "PayPal") {
                                    echo 'selected="selected"';
                                } ?>>PayPal</option>
                                <option value="Google Pay" <?php if ($cpm_payment_method == "Google Pay") {
                                    echo 'selected="selected"';
                                } ?>>Google Pay</option>
                                <option value="Bank Transfer" <?php if ($cpm_payment_method == "Bank Transfer") {
                                    echo 'selected="selected"';
                                } ?>>Bank Transfer</option>
                                <option value="Interac e-Transfer" <?php if ($cpm_payment_method == "Interac e-Transfer") {
                                    echo 'selected="selected"';
                                } ?>>Interac e-Transfer</option>
                                <option value="Western Union" <?php if ($cpm_payment_method == "Western Union") {
                                    echo 'selected="selected"';
                                } ?>>Western Unionr</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="cpm_payment_details">Payment Details<span class="required-field">*</span></label>
                            <textarea class="cpm_payment_details" name="cpm_payment_details" required><?php
                            if (!empty($cpm_payment_details)) {
                                echo $cpm_payment_details;
                            }
                            ?></textarea>
                        </div>
                        <div class="wp-block-buttons">
                            <button type="submit" class="wp-block-button wp-block-button__link "
                                name="cpm_update_user_payment_info">Save</button>
                        </div>
                    </form>
...
<?php
                    ...
                    <p class="profile-available-commision-text profile-paragraph">
                        ...
                        The short codes below are “commissions.” They are given by the RAEs to writers they want to work
                        with.
                    ...
                    if ($user_role == "admin") {
                        ...
                        $from = "meta";
                        $all_commissions = get_user_meta($current_user_id, 'commissions', true);

                        if (is_array($all_commissions)) {

                            $total_commissions = count($all_commissions);
                            $total_pages = ceil($total_commissions / $codes_per_page);

                            // Slice the array to get the commissions for the current page
                            $results = array_slice($all_commissions, $offset, $codes_per_page, true);
                        } else {
                            $results = [];
                        }
                    }
                    ...
                    if ($results) {
                        ...
                        } else if ($from === "meta" && $user_role == 'rae') {

                            foreach ($results as $code) {
                                $curr_status = $wpdb->get_var($wpdb->prepare("SELECT status FROM `$table_name` WHERE code = '" . $code . "'"));
                                $checkbox_status = '';
                                $status = 'Available';
                                if ($curr_status == 2) {
                                    $checkbox_status = 'disabled';
                        ...
                        } else if ($from === "meta" && ($user_role == 'user')) {

                            foreach ($results as $code => $referrer_id) {
                                $curr_status = $wpdb->get_var($wpdb->prepare("SELECT status FROM `$table_name` WHERE code = '" . $code . "'"));
                                $checkbox_status = '';
                                $status = 'Available';
                                if ($curr_status == 2) {
                        ...
                        if ($user_role == "admin") {
                            ...
                            $total_codes = sizeof($all_commissions);
                        }
                        ...
                        echo '<p class="profile-available-commision-text profile-paragraph profile-commission-not-available-notice"> 
                            ...
                            Dear  '.$current_user->user_login.',you currently have no commissions. Don’t worry—new commissions are 
                            available from RAEs and sometimes from other writers who have extras. 
                            To receive commissions, keep being active—keep reading and taking part in group workshops, 
                            if you enjoy them. Keep writing and post the writing you are most proud of to your Contributor’s Page. 
                            Read other writers and let them know if you enjoy their work. Commissions come to active writers and readers. Click
                            <u class="request-commission" style="cursor:pointer"><strong>here</strong></u>
                            if you want all the RAEs to be alerted 
                            that you are looking for a commission.
                        </p>';
                    }
                    ?>
                    ...
                    <div class="form-group profile-assing-to-form">
                        ...
                        <?php if ($user_role == 'rae' || $user_role == 'admin') { ?>
                            <div class="all-contributors-seeking-commmission">
